...
Category: Reference
Summary: This README entry points to documentation about functional testing using Cypress for the Contrib Tracker theme, both on a portal and its source code.
Overview: Read more about functional testing using Cypress on [the portal](https://idp.axelerant.com/catalog/default/component/contrib-tracker/docs/func_testing/) ([source](/docs/func_testing.md)).
Usage: Not Applicable.
Dependencies: Cypress (implied).
