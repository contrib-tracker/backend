...
describe(
  'Name Input Filter Validation with Positive and Negative Scenarios',
  { tags: '@form' },
  () => {
    ...
    it('should show right results on name input', { tags: '@positive' }, () => {
    ...
    it(
      'should show no results for incorrect name input',
      { tags: '@negative' },
      () => {
    ...
    it(
      'should show no results for excessively long name input',
      { tags: '@negative' },
      () => {
    ...
    it(
      'should show no results for numerical name input',
      { tags: '@negative' },
      () => {
    ...
    it(
      'should show no results for special characters in name input',
      { tags: '@negative' },
      () => {
